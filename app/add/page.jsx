  ...
  return (
    <div className="p-8 max-w-5xl mx-auto mb-4 md:mb-0 animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-4">
        <div className="flex gap-2 p-2 bg-slate-100 dark:bg-[#121212] rounded-[2rem] w-fit border-4 border-white dark:border-[#27272A] shadow-inner dark:shadow-none">
          <button
      ...
      <Card className="border-none shadow-2xl shadow-slate-200/80 dark:shadow-none rounded-[2.5rem] overflow-hidden">
        <div className="p-10 bg-slate-50 dark:bg-[#121212] border-b border-slate-100 dark:border-[#27272A]">
        ...
        <CardContent className="p-10 bg-white dark:bg-[#1A1A1A]">
